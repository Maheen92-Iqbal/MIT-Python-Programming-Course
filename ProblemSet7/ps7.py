...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        ...
        if self.phrase in story.getTitle() or self.phrase in story.getSummary() or self.phrase in story.getSubject():
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if triggerType == 'TITLE':
        ...
        triggerMap[name] = TitleTrigger(params[0]) #param is the word on which we need to use the trigger
        ...
        triggerMap[name] = AndTrigger(params[0],params[1])
        
    elif triggerType == 'OR':
        
        triggerMap[name] = OrTrigger(params[0],params[1])
...
def main_thread(master):
    ...
    try:
        ...
        triggerlist = readTriggerConfig("D:\python\MIT Program\ProblemSet7\triggers.txt")
